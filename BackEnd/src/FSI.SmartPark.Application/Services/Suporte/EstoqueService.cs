...
public class EstoqueService : IEstoqueService
{
    ...
    public async Task<EstoqueResponseDto> Criar(EstoqueRequestDto dto)
    {
        ...
        var id      = await _estoqueRepo.Add(estoque);
        var criado  = await _estoqueRepo.GetById(id);
    ...
    {
        var lista = await _estoqueRepo.GetAll();
        return lista
    ...
    {
        var materiais = await _materialRepo.GetAll();
        return materiais
